...
class Programs(models.Model):
    ...
    interest_type = models.ForeignKey(
        InterestChoice, on_delete=models.DO_NOTHING)
    interest_rate_type = models.ForeignKey(
        InterestRateType, on_delete=models.DO_NOTHING)
...
class Pairings(models.Model):
    ...
    counterparty_id = models.OneToOneField(
        "accounts.CounterParty", on_delete=models.CASCADE)
...
class workflowitems(models.Model):
    ...
    counterparty = models.OneToOneField(
        "accounts.Counterparty", on_delete=models.CASCADE, blank=True, null=True)
    ...
    next_available_transitions = ArrayField(models.CharField(
        max_length=500, blank=True, null=True, default=None), blank=True, null=True, default=None)
...
class File(models.Model):
    ...
    program = models.ForeignKey(
        Programs, on_delete=models.CASCADE, blank=True, null=True)
    pairing = models.ForeignKey(
        Pairings, on_delete=models.CASCADE, blank=True, null=True)
    invoice_upload = models.ForeignKey(
        Invoiceuploads, on_delete=models.CASCADE, blank=True, null=True)
