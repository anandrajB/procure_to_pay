...
urlpatterns = [
    ...
    path('party-status/<int:pk>/',PartyStatusUpdateApiview.as_view()),
    path('party-check/',PartiesCheckApiView.as_view(),name = 'ac/no or customer_id check'),
    path('counterparty/', CounterPartyListCreateAPIView.as_view()),
